...
Uma tendência é a direção geral em que um mercado se move. Existem três tipos principais:
- Tendência de Alta
- Tendência de Baixa
- Tendência Lateral
...
### 1. Médias Móveis
As médias móveis são um dos indicadores mais populares e eficazes para identificar tendências. Elas suavizam os dados de preço para criar uma linha de tendência que é mais fácil de seguir.

### 2. MACD (Moving Average Convergence Divergence)
O MACD é um indicador versátil que pode ajudar a identificar:
