                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} lg={8}>
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={12}>
                                        <DashboardItem>Índices</DashboardItem>
                                    </Grid>
                            ...
                            <Grid item xs={12} lg={4}>
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={12} sm={6} lg={12}>
                                        <DashboardItem>Selic</DashboardItem>
                                    </Grid>

                                    {/* User Position */}
                                    <Grid item xs={12} sm={6} lg={12}>
                                        <DashboardItem>Posição do Usuário</DashboardItem>
                                    </Grid>

                                    {/* Inflation Chart */}
                                    <Grid item xs={12}>
                                        <DashboardItem>Inflação</DashboardItem>
                                    </Grid>
