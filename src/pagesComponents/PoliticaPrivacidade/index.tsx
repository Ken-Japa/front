                            ...
                            <Container maxWidth="lg" className="py-16">
                                {isLoading ? (
                                    ...
                                    <>
                                        ...
                                        >
                                            <div id="dados" className="bg-[#ffffff08] p-6 rounded-lg">
                                                <h2 id="dados-title" className="text-2xl text-[#0D95F9] mb-5">
                                                    I - DADOS PESSOAIS
                                                </h2>
                                                <p text-white>
                                            ...
                                            <div id="finalidade" className="bg-[#ffffff08] p-6 rounded-lg">
                                            ...
                                            <div id="compartilhamento" className="bg-[#ffffff08] p-6 rounded-lg">
                                            ...
                                            <div id="transferencia" className="bg-[#ffffff08] p-6 rounded-lg">
                                            ...
                                            <div id="consentimento" className="bg-[#ffffff08] p-6 rounded-lg">
                                            ...
                                            <div id="armazenamento" className="bg-[#ffffff08] p-6 rounded-lg">
                                            ...
                                            <div id="retencao" className="bg-[#ffffff08] p-6 rounded-lg">
                                            ...
                                            <div id="direitos" className="bg-[#ffffff08] p-6 rounded-lg">
